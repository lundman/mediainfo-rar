...
void CommandData::OutHelp()
{
  ...
  static MSGID Help[]={
    ...
    MCHelpSwPm,MCHelpSwR,MCHelpSwRI,MCHelpSwSL,MCHelpSwSM,MCHelpSwSK,MCHelpSwTA,
    ...
    MCHelpSwSL,MCHelpSwSK,MCHelpSwSM,MCHelpSwT,MCHelpSwTA,MCHelpSwTB,MCHelpSwTK,
